...
#define PTE_MT_PBMT_PMA		(0ull << 61)
#define PTE_MT_PBMT_NC		(1ull << 61)
#define PTE_MT_PBMT_IO		(2ull << 61)
#define PTE_MT_PBMT_MASK	(3ull << 61)

#define PTE_MT_THEAD_MEM	(0xeull  << 59)
#define PTE_MT_THEAD_NC		(0ull    << 59)
#define PTE_MT_THEAD_IO		(0x10ull << 59)
#define PTE_MT_THEAD_MASK	(0x1Full << 59)
