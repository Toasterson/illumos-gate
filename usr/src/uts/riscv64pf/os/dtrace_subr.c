...
static int
dtrace_xcall_func(xc_arg_t func, xc_arg_t arg0, xc_arg_t)
{
	(*((dtrace_xcall_t)(uintptr_t)func))((void *)arg0);
...
void
dtrace_user_probe(struct regs *rp)
{
	...
	if (rp->r_tp != 0 && (rp->r_pc == rp->r_tp + sizeof(void *) + 2 || rp->r_pc == rp->r_tp + sizeof (void *) + 4)) {
