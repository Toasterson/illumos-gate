...
OBJECTS= b_exp.o b_log.o b_tgamma.o \
	...
	s_cbrt.o s_cbrtf.o s_ceil.o s_ceilf.o s_clog.o s_clogf.o \
	...
	s_fmax.o s_fmaxf.o s_fmin.o \
	s_fminf.o s_frexp.o s_frexpf.o s_ilogb.o s_ilogbf.o \
...
OBJECTS_LD128+= 	catrigl.o \
	e_acoshl.o e_acosl.o e_asinl.o e_atan2l.o e_atanhl.o \
	e_coshl.o e_fmodl.o e_hypotl.o \
	e_lgammal.o e_lgammal_r.o e_powl.o \
	e_remainderl.o e_sinhl.o e_sqrtl.o \
	invtrig.o k_cosl.o k_sinl.o k_tanl.o \
	s_asinhl.o s_atanl.o s_cbrtl.o s_ceill.o \
	s_clogl.o s_cosl.o s_cprojl.o \
	s_csqrtl.o s_erfl.o s_exp2l.o s_expl.o s_floorl.o s_fmal.o \
	s_fmaxl.o s_fminl.o s_frexpl.o s_logbl.o s_logl.o s_nanl.o \
	s_nextafterl.o s_nexttoward.o s_remquol.o s_rintl.o s_roundl.o \
	s_scalbnl.o s_sinl.o s_sincosl.o \
	s_tanhl.o s_tanl.o s_truncl.o w_cabsl.o

OBJECTS_aarch64 = $(OBJECTS_LD128)
OBJECTS_riscv64 = $(OBJECTS_LD128)

OBJECTS+= 	catrig.o catrigf.o \
	s_ccosh.o s_ccoshf.o s_cexp.o s_cexpf.o \
	s_cimag.o s_cimagf.o s_cimagl.o \
	s_conj.o s_conjf.o s_conjl.o \
	s_cpow.o s_cpowf.o s_cpowl.o \
	s_cproj.o s_cprojf.o s_creal.o s_crealf.o s_creall.o \
	s_csinh.o s_csinhf.o s_ctanh.o s_ctanhf.o

OBJECTS+=	s_fabs.o s_ldexp.o s_modf.o
...
CPPFLAGS_riscv64 += -I$(MSUN_BASE)/ld128
CPPFLAGS += $(CPPFLAGS_$(MACH))
CFLAGS += -_gcc=-fno-builtin
CFLAGS += -_gcc=-Wno-parentheses
CFLAGS += -_gcc=-Wno-unused-variable
CFLAGS += -_gcc=-Wno-misleading-indentation
CFLAGS += -_gcc=-Wno-unused-but-set-variable
LDLIBS +=	-lc
CSTD= $(CSTD_GNU99)
